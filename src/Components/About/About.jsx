  ...
  return (
    <div className=''>
       ...
       <div className='w-screen flex justify-center mt-4'>
        <div className=' border-blue1color border-4 w-[80%]  flex flex-col items-center py-2 overflow-hidden justify-center'>
            <h1 className='text-2xl text-blue1color font-extrabold'>CAS inpt</h1>
